...
export default function ProductList() {
  ...
  return (
    <>
                  ...
                  <div>
                    <h3 className="text-sm text-gray-700">
                      ...
                      <button
                        type="button"
                        onClick={() => setIsDialogOpen(true)}
                        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 hidden group-hover:flex items-center justify-center px-4 py-2 rounded-md bg-white/90 text-gray-800 text-sm font-medium shadow-md transition duration-200"
                        title="Quick View"
                      >
                        <svg
      ...
      <ProductView open={isDialogOpen} onClose={() => setIsDialogOpen(false)} />
    </>
  );
}
